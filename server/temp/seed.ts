 //seed.ts is used to add information to the mongo atlas instance

// process personal info from .env file
require("dotenv").config();

// imports ObjectID from mongodb to generate UUID
import { ObjectId } from 'mongodb';
// imports connectDatabase function
import { connectDatabase } from "../src/database";
// imports Listing types that are used for MongoDB
...
// declares document that's going to be used for mongo, seed information

        
// for loop to add each entry of listing to mongodb atlas
